          ...
          <div className="md:hidden">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="px-2 space-y-1">
                {status === 'loading' ? (
                  <div className="px-3 py-2 text-base font-medium text-gray-500">載入中...</div>
                ) : session ? (
                  <div className="px-3 py-2">
                    ...
                    <button
                      ...
                      className="w-full flex items-center px-3 py-2 text-base font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-md transition-colors"
                    >
