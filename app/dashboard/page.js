...
export default function Home() {
  ...
  return (
    <AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {goals.length === 0 ? (
          <div className="text-center py-16">
            <FiTarget className="mx-auto h-24 w-24 text-gray-400 dark:text-gray-500 mb-8 transition-colors" />
            ...
            >
              ...
              <button
                ...
                className={`inline-flex items-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-md transition-colors ${
                  loadingSample 
              ...
              >
                {loadingSample ? (
                  <>
                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-gray-600 dark:border-gray-400 mr-2"></div>
                    載入中...
                  </>
                ) : (
                  <>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">已完成目標</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">整體進度</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <FiUser className="h-8 w-8 text-orange-600 dark:text-orange-400" />
                  </div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">與未來差距</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{100 - overallProgress}%</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* 進度圖表 */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">目標進度總覽</h2>
            ...
            {/* 目標詳細列表 */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">詳細進度</h2>
              <div className="space-y-6">
                {goals.map((goal) => {
                  ...
                  return (
                    <div key={goal.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 transition-colors">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">完成度</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <p className="font-medium text-gray-700 dark:text-gray-300">目前的自己：</p>
                          <p className="text-gray-600 dark:text-gray-400 mt-1">{goal.currentSelfDescription || '尚未設定'}</p>
                        </div>
                        <div>
                          <p className="font-medium text-gray-700 dark:text-gray-300">未來的自己：</p>
                          <p className="text-gray-600 dark:text-gray-400 mt-1">{goal.futureSelfDescription || '尚未設定'}</p>
                        </div>
                      </div>
